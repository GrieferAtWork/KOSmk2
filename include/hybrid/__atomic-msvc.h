...
#define __impl_hybrid_atomic_cmpxch_val_seqcst(x,oldv,newv) \
  __TYPEOF_RECAST(x,sizeof(x) == 1 ? (__UINT8_TYPE__)__NAMESPACE_INT_SYM _InterlockedCompareExchange8((char volatile *)&(x),(char)(newv),(char)(oldv)) : \
...
(__impl_hybrid_atomic_cmpxch_val##n)(void *__x, __UINT##n##_TYPE__ __oldv, \
...
__T __FORCELOCAL (__hybrid_atomic_cmpxch_val)(__T &__x, __OV __oldv, __NV __newv, int __fail, int __succ) {
...
#define __hybrid_atomic_cmpxch_val(x,oldv,newv,fail,succ) \
  __TYPEOF_RECAST(x,sizeof(x) == 1 ? (__UINT8_TYPE__)__NAMESPACE_INT_SYM __impl_hybrid_atomic_cmpxch_val8(&(x),(__UINT8_TYPE__)(newv),(__UINT8_TYPE__)(oldv),fail,succ) : \
...
__FORCELOCAL __int64 (_InterlockedExchange64)(__int64 volatile *__px, __int64 __v) { __int64 __res; do { __COMPILER_READ_BARRIER(); __res = *__px; } while (_InterlockedCompareExchange64(__px,__v,__res) != __res); return __res; }
__FORCELOCAL __int64 (_InterlockedExchangeAdd64)(__int64 volatile *__px, __int64 __v) { __int64 __res; do { __COMPILER_READ_BARRIER(); __res = *__px; } while (_InterlockedCompareExchange64(__px,__res+__v,__res) != __res); return __res; }
__FORCELOCAL __int64 (_InterlockedAnd64)(__int64 volatile *__px, __int64 __v) { __int64 __res; do { __COMPILER_READ_BARRIER(); __res = *__px; } while (_InterlockedCompareExchange64(__px,__res&__v,__res) != __res); return __res; }
__FORCELOCAL __int64 (_InterlockedOr64)(__int64 volatile *__px, __int64 __v) { __int64 __res; do { __COMPILER_READ_BARRIER(); __res = *__px; } while (_InterlockedCompareExchange64(__px,__res|__v,__res) != __res); return __res; }
__FORCELOCAL __int64 (_InterlockedXor64)(__int64 volatile *__px, __int64 __v) { __int64 __res; do { __COMPILER_READ_BARRIER(); __res = *__px; } while (_InterlockedCompareExchange64(__px,__res^__v,__res) != __res); return __res; }
#endif /* Emulated... */
...
__T __FORCELOCAL (__impl_hybrid_atomic_xch_seqcst)(__T &__x, __V __v) {
...
__T __FORCELOCAL (__impl_hybrid_atomic_fetchadd_seqcst)(__T &__x, __V __v) {
...
__T __FORCELOCAL (__impl_hybrid_atomic_fetchand_seqcst)(__T &__x, __V __v) {
...
__T __FORCELOCAL (__impl_hybrid_atomic_fetchor_seqcst)(__T &__x, __V __v) {
...
__T __FORCELOCAL (__impl_hybrid_atomic_fetchxor_seqcst)(__T &__x, __V __v) {
...
#define __impl_hybrid_atomic_xch_seqcst(x,v) \
  __TYPEOF_RECAST(x,sizeof(x) == 1 ? (__UINT8_TYPE__ )__NAMESPACE_INT_SYM _InterlockedExchange8((char volatile *)&(x),(char)(v)) : \
...
#define __impl_hybrid_atomic_fetchadd_seqcst(x,v) \
  __TYPEOF_RECAST(x,sizeof(x) == 1 ? (__UINT8_TYPE__ )__NAMESPACE_INT_SYM _InterlockedExchangeAdd8((char volatile *)&(x),(char)(v)) : \
...
#define __impl_hybrid_atomic_fetchand_seqcst(x,v) \
  __TYPEOF_RECAST(x,sizeof(x) == 1 ? (__UINT8_TYPE__ )__NAMESPACE_INT_SYM _InterlockedAnd8((char volatile *)&(x),(char)(v)) : \
...
#define __impl_hybrid_atomic_fetchor_seqcst(x,v) \
  __TYPEOF_RECAST(x,sizeof(x) == 1 ? (__UINT8_TYPE__ )__NAMESPACE_INT_SYM _InterlockedOr8((char volatile *)&(x),(char)(v)) : \
...
#define __impl_hybrid_atomic_fetchxor_seqcst(x,v) \
  __TYPEOF_RECAST(x,sizeof(x) == 1 ? (__UINT8_TYPE__ )__NAMESPACE_INT_SYM _InterlockedXor8((char volatile *)&(x),(char)(v)) : \
...
#define __DEFINE_WRAPPER(n,y,T) \
__FORCELOCAL __UINT##n##_TYPE__ \
(__impl_hybrid_atomic_xch##n)(void *__x, __UINT##n##_TYPE__ __v, int __order) { \
...
__FORCELOCAL __UINT##n##_TYPE__ \
(__impl_hybrid_atomic_fetchadd##n)(void *__x, __UINT##n##_TYPE__ __v, int __order) { \
...
__FORCELOCAL __UINT##n##_TYPE__ \
(__impl_hybrid_atomic_fetchand##n)(void *__x, __UINT##n##_TYPE__ __v, int __order) { \
...
__FORCELOCAL __UINT##n##_TYPE__ \
(__impl_hybrid_atomic_fetchor##n)(void *__x, __UINT##n##_TYPE__ __v, int __order) { \
...
__FORCELOCAL __UINT##n##_TYPE__ \
(__impl_hybrid_atomic_fetchxor##n)(void *__x, __UINT##n##_TYPE__ __v, int __order) { \
...
__T __FORCELOCAL (__hybrid_atomic_xch)(__T &__x, __V __v, int __order) {
...
__T __FORCELOCAL (__hybrid_atomic_fetchadd)(__T &__x, __V __v, int __order) {
...
__T __FORCELOCAL (__hybrid_atomic_fetchand)(__T &__x, __V __v, int __order) {
...
__T __FORCELOCAL (__hybrid_atomic_fetchor)(__T &__x, __V __v, int __order) {
...
__T __FORCELOCAL (__hybrid_atomic_fetchxor)(__T &__x, __V __v, int __order) {
...
#define __hybrid_atomic_xch(x,v,order) \
  __TYPEOF_RECAST(x,sizeof(x) == 1 ? (__UINT8_TYPE__)__NAMESPACE_INT_SYM __impl_hybrid_atomic_xch8(&(x),(__UINT8_TYPE__)(v),order) : \
...
#define __hybrid_atomic_fetchadd(x,v,order) \
  __TYPEOF_RECAST(x,sizeof(x) == 1 ? (__UINT8_TYPE__)__NAMESPACE_INT_SYM __impl_hybrid_atomic_fetchadd8(&(x),(__UINT8_TYPE__)(v),order) : \
...
#define __hybrid_atomic_fetchand(x,v,order) \
  __TYPEOF_RECAST(x,sizeof(x) == 1 ? (__UINT8_TYPE__)__NAMESPACE_INT_SYM __impl_hybrid_atomic_fetchand8(&(x),(__UINT8_TYPE__)(v),order) : \
...
#define __hybrid_atomic_fetchor(x,v,order) \
  __TYPEOF_RECAST(x,sizeof(x) == 1 ? (__UINT8_TYPE__)__NAMESPACE_INT_SYM __impl_hybrid_atomic_fetchor8(&(x),(__UINT8_TYPE__)(v),order) : \
...
#define __hybrid_atomic_fetchxor(x,v,order) \
  __TYPEOF_RECAST(x,sizeof(x) == 1 ? (__UINT8_TYPE__)__NAMESPACE_INT_SYM __impl_hybrid_atomic_fetchxor8(&(x),(__UINT8_TYPE__)(v),order) : \
