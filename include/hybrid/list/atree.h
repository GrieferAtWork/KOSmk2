 ...
 */
#ifndef GUARD_HYBRID_ATREE_H
#define GUARD_HYBRID_ATREE_H 1
...
#define ATREE_NODE(T,Tkey) \
 struct { T    *a_min;  /*< [0..1][->[...].a_vmax < a_vmin] Lower node. */ \
          T    *a_max;  /*< [0..1][->[...].a_vmin > a_vmax] Upper node. */ \
          Tkey  a_vmin; /*< Lower bound. */ \
          Tkey  a_vmax; /*< Upper bound. */ \
 }

#define ATREE_XNODE(T) \
 struct { T    *a_min;  /*< [0..1][->[...].USER(a_vmax) < USER(a_vmin)] Lower node. */ \
          T    *a_max;  /*< [0..1][->[...].USER(a_vmin) > USER(a_vmax)] Upper node. */ \
 }
