...
__LOCAL __WUNUSED __ATTR_RETNONNULL __ATTR_PURE __NONNULL((1)) __UINT64_TYPE__ *(__LIBCCALL __libc_rawmemchrq)(__UINT64_TYPE__ const *__restrict __haystack, __UINT64_TYPE__ __needle) { __UINT64_TYPE__ *__iter = (__UINT64_TYPE__ *)__haystack; while (*__iter != __needle) ++__iter; return __iter; }
