...
__DEFINE_MEMCMP(__constant_memcmp,__nonconst_memcmp,__n_bytes,int,__INT8_TYPE__)
__DEFINE_MEMCMP(__constant_memcmpw,__nonconst_memcmpw,__n_words,__INT16_TYPE__,__INT16_TYPE__)
__DEFINE_MEMCMP(__constant_memcmpl,__nonconst_memcmpl,__n_dwords,__INT32_TYPE__,__INT32_TYPE__)
