...
#ifdef __USE_GNU
__LIBC reg_syntax_t (__LIBCCALL re_set_syntax)(reg_syntax_t __syntax);
__LIBC char const *(__LIBCCALL re_compile_pattern)(char const *__pattern, size_t __length, struct re_pattern_buffer *__buffer);
__LIBC int (__LIBCCALL re_compile_fastmap)(struct re_pattern_buffer *__buffer);
__LIBC int (__LIBCCALL re_search)(struct re_pattern_buffer *__buffer, char const *__string, int __length, int __start, int __range, struct re_registers *__regs);
__LIBC int (__LIBCCALL re_search_2)(struct re_pattern_buffer *__buffer, char const *__string1, int __length1, char const *__string2, int __length2, int __start, int __range, struct re_registers *__regs, int __stop);
__LIBC int (__LIBCCALL re_match)(struct re_pattern_buffer *__buffer, char const *__string, int __length, int __start, struct re_registers *__regs);
__LIBC int (__LIBCCALL re_match_2)(struct re_pattern_buffer *__buffer, char const *__string1, int __length1, char const *__string2, int __length2, int __start, struct re_registers *__regs, int __stop);
__LIBC void (__LIBCCALL re_set_registers)(struct re_pattern_buffer *__buffer, struct re_registers *__regs, unsigned int __num_regs, regoff_t *__starts, regoff_t *__ends);
#endif /* __USE_GNU */

#if defined(_REGEX_RE_COMP) || (defined(_LIBC) && defined(__USE_MISC))
#ifndef _CRAY
__LIBC char *(__LIBCCALL re_comp)(char const *);
__LIBC int (__LIBCCALL re_exec)(char const *);
#endif /* !_CRAY */
