...
#define ARG_MAX       131072 /*< # bytes of args + environ for exec(); TODO: Not implemented; Add kernel commandline option & per-task limit option. */
#define LINK_MAX         127 /*< # links a file may have */
#define MAX_CANON        255 /*< size of the canonical input queue */
#define MAX_INPUT        255 /*< size of the type-ahead buffer */
#define NAME_MAX         255 /*< # chars in a file name (Unlimited in KOS) */
