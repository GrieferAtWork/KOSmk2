...
#define VIRTINFO_DATA_SOURCEID 2 /*< A unique ID that is equal only for code generated by the same source file. (HINT: ZERO is the invalid ID) */
#define VIRTINFO_DATA_FLAGS    3 /*< Set of 'VIRTINFO_FLAG_*' */
