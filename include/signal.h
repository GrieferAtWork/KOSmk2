...
__LIBC __ATTR_DEPRECATED_ int (__LIBCCALL sigblock)(int __mask);
__LIBC __ATTR_DEPRECATED_ int (__LIBCCALL sigsetmask)(int __mask);
__LIBC __ATTR_DEPRECATED_ int (__LIBCCALL siggetmask)(void);
#undef _sys_siglist
#undef sys_siglist
