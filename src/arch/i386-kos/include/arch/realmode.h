 ...
 */
#ifndef GUARD_ARCH_I386_KOS_INCLUDE_ARCH_REALMODE_H
#define GUARD_ARCH_I386_KOS_INCLUDE_ARCH_REALMODE_H 1
...
#endif /* !GUARD_ARCH_I386_KOS_INCLUDE_ARCH_REALMODE_H */
