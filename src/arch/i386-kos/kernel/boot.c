...
L(    movl  $0,                              %eax                             )
L(    movl  $(__kernel_start - CORE_BASE), %edi                               )
L(2:  jmp 2b                                                                  )
L(1:  call  bdsk_read                                                         )
L(    addl  $512, %edi                                                        )
L(    incl  %eax                                                              )
...
#if 0
L(__bochs_start:                                                              )
L(    movb $(BOOT_EMULATION_BOCHS), (boot_emulation - CORE_BASE)              )
L(    movw $(0xe9), (boot_emulation_logport - CORE_BASE)                      )
#endif
...
L(    movl $((coreboot_e2_80000000 - ASM_CORE_BASE)+(PDIR_ATTR_GLOBAL|PDIR_ATTR_WRITE|PDIR_ATTR_PRESENT)), (coreboot_e3 - ASM_CORE_BASE)+((PDIR_E3_COUNT-2)*8))
L(    movl $((coreboot_e2_c0000000 - ASM_CORE_BASE)+(PDIR_ATTR_GLOBAL|PDIR_ATTR_WRITE|PDIR_ATTR_PRESENT)), (coreboot_e3 - ASM_CORE_BASE)+((PDIR_E3_COUNT-1)*8))
L(    movl $(PDIR_ATTR_GLOBAL|PDIR_ATTR_2MIB|PDIR_ATTR_WRITE|PDIR_ATTR_PRESENT), %edx)
L(    leal (coreboot_e2_80000000 - ASM_CORE_BASE), %edi                       )
...
L(    loop 1b                                                                 )
L(    leal (coreboot_e2_c0000000 - ASM_CORE_BASE), %edi                       )
L(    movl $(PDIR_E2_COUNT), %ecx                                             )
L(1:  movl %edx, %eax                                                         )
L(    stosl                                                                   )
L(    xorl %eax, %eax                                                         )
...
L(    leal ((__kernel_end - ASM_CORE_BASE)+EARLY_PAGE_GAP), %edi                              )
L(    movl $(((__kernel_end - ASM_CORE_BASE)+EARLY_PAGE_GAP+PAGESIZE) + (PDIR_ATTR_WRITE|PDIR_ATTR_PRESENT)), %eax)
L(    stosl /* Point the first level-4 entry to a level-3 entry at `(__kernel_end - ASM_CORE_BASE)+EARLY_PAGE_GAP+PAGESIZE' */)
L(    xorl %eax, %eax                                                         )
L(    stosl                                                                   )
...
L(    ljmp $0x08, $(boot_enter_longmode - ASM_CORE_BASE)                      )
L(                                                                            )
L(76: leal  boot_erstr1 - ASM_CORE_BASE, %ebp                                 )
L(    jmp   boot_error                                                        )
L(77: leal  boot_erstr2 - ASM_CORE_BASE, %ebp                                 )
L(    jmp   boot_error                                                        )
L(78: leal  boot_erstr3 - ASM_CORE_BASE, %ebp                                 )
L(    jmp   boot_error                                                        )
L(                                                                            )
...
L(    .long  boot_gdt_vector  - ASM_CORE_BASE                                 )
L(SYM_END(boot_gdt)                                                           )
L(                                                                            )
...
L(    leal 0xb8000, %edi                                                      )
L(    leal boot_erstr0 - ASM_CORE_BASE, %esi                                  )
...
L(    leal  (__bootcpu_begin - CORE_BASE),   %edi                             )
...
#endif /* !__x86_64__ */
#define BOOTCPU(x)  (__bootcpu-ASM_CORE_BASE+(x))
L(                                                                            )
...
L(    movb   $(BOOT_EMULATION_QEMU), boot_emulation - ASM_CORE_BASE           )
L(    movw   $(0x3F8),               boot_emulation_logport - ASM_CORE_BASE   )
L(2:                                                                          )
#ifndef __x86_64__
