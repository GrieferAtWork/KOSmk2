...
#define USER_TASK_TLB_ADDRHINT       __UINTPTR_C(0x80000000) /* Address hint for the per-thread TLB/TIB block. (Grows down) */
#define USER_ENVIRON_ADDRHINT       (__UINTPTR_C(0x80000000)-(4*PAGESIZE)) /* Address hint when attempting to place the appenv data block in user-space. (Grows down) */
...
#define HOST_USHARE_WRITE_ADDRHINT   __UINTPTR_C(0x80000000) /* Address hint for mapping the writable copy of the user-share segment. (Grows down) */
