...
#define SEG_DATA_PL0    (SEG_FLAG_LONGMODE|SEG_ACCESS_SYSTEM|SEG_ACCESS_PRESENT|SEG_ACCESS_PRIVL(0)|SEG_DATA_RDWR)
#define SEG_CODE_PL3    (SEG_FLAG_LONGMODE|SEG_ACCESS_SYSTEM|SEG_ACCESS_PRESENT|SEG_ACCESS_PRIVL(3)|SEG_CODE_EXRD)
#define SEG_DATA_PL3    (SEG_FLAG_LONGMODE|SEG_ACCESS_SYSTEM|SEG_ACCESS_PRESENT|SEG_ACCESS_PRIVL(3)|SEG_DATA_RDWR)
#else
