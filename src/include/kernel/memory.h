 ...
 */
#define MZONE_1MB          0x00 /* [0x00000000..0x000fffff] Physical, dynamic memory within the first 1Mb of memory.
...
#define MZONE_MAXNONEMPTY  0x06 /* The greatest non-empty memory zone (`MZONE_VIRTUAL|MZONE_32BIT' or `MZONE_VIRTUAL|MZONE_HIMEM' doesn't exist and is ignored). */
...
#else
#define MZONE_HIMEM        0x01 /* [0x00100000..0xbfffffff] The main physical memory zone containing all to-called ~high~ memory. */
#define MZONE_COUNT        0x02 /* The amount of zones there are. */
#define MZONE_MAXNONEMPTY  0x01 /* The greatest non-empty memory zone. */
#define MZONE_REAL_COUNT   0x02 /* The real amount of zones there are. */
