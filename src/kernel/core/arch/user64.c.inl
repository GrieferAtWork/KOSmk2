...
L(4:  movq $1f, %rdx; pushq %rdx                                 )
L(    movq $(EXC_PAGE_FAULT), %rdx; pushq %rdx                   )
...
L(3:  cmpq  $__kernel_user_start, %rsi                           )
L(    jb    1b /* if (dst < __kernel_user_start) fail(); */      )
L(    cmpq  $__kernel_user_end,   %rdx                           )
...
L(3:  cmpq  $__kernel_user_start, %rsi                           )
L(    jb    1b /* if (str < __kernel_user_start) return NULL; */ )
L(    cmpq  $__kernel_user_end, %rsi                             )
L(    jae   1b /* if (str >= __kernel_user_end) return NULL; */  )
L(    movq  $__kernel_user_end, %rax                             )
L(    subq  %rsi, %rax                                           )
L(    jmp   4b                                                   )
...
L(    jae   98f                                                  )
L(    jmp  *transmute(,%rsi,8) /* Transmute registers. */        )
L(                                                               )
