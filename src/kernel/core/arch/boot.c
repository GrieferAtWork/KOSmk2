...
L(    cpuid                                                                   )
L(    testl $(1 << 29), %edx /* Test the LM bit. */                           )
L(    jz    77f                                                               )
L(                                                                            )
L(    /* Check SSE support */                                                 )
L(    movl  $(0x1), %eax                                                      )
...
L(    movl $(coreboot_e2_80000000_p+(PDIR_ATTR_GLOBAL|PDIR_ATTR_WRITE|PDIR_ATTR_PRESENT)), coreboot_e3_p+((PDIR_E3_COUNT-2)*8))
L(    movl $(coreboot_e2_c0000000_p+(PDIR_ATTR_GLOBAL|PDIR_ATTR_WRITE|PDIR_ATTR_PRESENT)), coreboot_e3_p+((PDIR_E3_COUNT-1)*8))
L(    movl $(PDIR_ATTR_GLOBAL|PDIR_ATTR_4MIB|PDIR_ATTR_WRITE|PDIR_ATTR_PRESENT), %edx)
L(    leal coreboot_e2_80000000_p, %edi                                       )
...
L(    loop 1b                                                                 )
L(    leal coreboot_e2_c0000000_p, %edi                                       )
L(    movl $(PDIR_E2_COUNT), %ecx                                             )
L(1:  movl %edx, %eax                                                         )
L(    stosl                                                                   )
L(    xorl %eax, %eax                                                         )
...
L(    leal __kernel_end_p, %edi                                               )
L(    movl $((__kernel_end_p + PAGESIZE) + (PDIR_ATTR_WRITE|PDIR_ATTR_PRESENT)), %eax)
L(    stosl /* Pointer the first level-4 entry to a level-3 entry at `__kernel_end_p + PAGESIZE' */)
L(    xorl %eax, %eax                                                         )
L(    movl $(PDIR_E3_COUNT*2-1), %ecx                                         )
L(    rep stosl /* Fill its remainder with unused entires. */                 )
L(    /* Now initialize the level-3 entry to identity-map the first 1Gb. */   )
L(    movl $(PDIR_E2_COUNT), %ecx                                             )
L(    movl $(PDIR_ATTR_4MIB|PDIR_ATTR_WRITE|PDIR_ATTR_PRESENT), %edx          )
L(1:  movl %edx, %eax                                                         )
L(    stosl                                                                   )
L(    xorl %eax, %eax                                                         )
L(    stosl                                                                   )
...
L(    ljmp $0x08, $boot_enter_longmode_p                                      )
L(                                                                            )
L(76: leal  boot_erstr1_p, %ebp                                               )
L(    jmp   boot_error                                                        )
L(77: leal  boot_erstr2_p, %ebp                                               )
L(    jmp   boot_error                                                        )
L(78: leal  boot_erstr3_p, %ebp                                               )
L(    jmp   boot_error                                                        )
L(                                                                            )
...
L(    movq $__percpu_dat_qwords, %rcx                                         )
L(    rep;  movsq                                                             )
L(                                                                            )
...
#define BOOTCPU(x)  (__bootcpu-CORE_BASE+(x))
#else /* !__x86_64__ */
