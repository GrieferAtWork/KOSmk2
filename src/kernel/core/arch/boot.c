...
L(    leal (__kernel_end_p+EARLY_PAGE_GAP), %edi                              )
L(    movl $((__kernel_end_p+EARLY_PAGE_GAP+PAGESIZE) + (PDIR_ATTR_WRITE|PDIR_ATTR_PRESENT)), %eax)
L(    stosl /* Point the first level-4 entry to a level-3 entry at `__kernel_end_p+EARLY_PAGE_GAP+PAGESIZE' */)
L(    xorl %eax, %eax                                                         )
L(    stosl                                                                   )
