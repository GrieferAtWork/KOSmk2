...
struct modseg __core_segments[] = {
    [0] = {
        .ms_type  = MODSEG_LOAD,
        .ms_fpos  = 0,
        .ms_vaddr = (maddr_t)KERNEL_RO_START,
        .ms_paddr = (maddr_t)virt_to_phys(KERNEL_RO_START),
    ...
    [1] = {
        .ms_type  = MODSEG_LOAD,
        .ms_fpos  = 0,
        .ms_vaddr = (maddr_t)KERNEL_RW_START,
        .ms_paddr = (maddr_t)virt_to_phys(KERNEL_RW_START),
