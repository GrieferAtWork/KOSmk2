...
#ifdef __x86_64__
L(    testb  $0x3, FRAME_SIZE+CPUSTATE_I_OFFSETOF_IRET+IRREGS_I_OFFSETOF_CS(%rsp))
L(    jz     1f                                                               )
L(    swapgs                                                                  )
L(    call   exec_deflirq                                                     )
L(    SKIP_FRAME                                                              )
...
#ifdef __x86_64__
L(    testb  $0x3, FRAME_SIZE+CPUSTATE_IE_OFFSETOF_IRET+IRREGS_IE_OFFSETOF_CS(%rsp))
L(    jz     1f                                                               )
L(    swapgs                                                                  )
L(    call exec_deflirq                                                       )
L(    SKIP_FRAME                                                              )
...
#ifdef __x86_64__
L(    testb  $0x3, IRREGS_I_OFFSETOF_CS(%rsp)                                 )
...
#ifdef __x86_64__
L(    testb  $0x3, IRREGS_IE_OFFSETOF_CS(%rsp)                                )
L(    jz     1f /* if (ORIGINATES_FROM_USERSPACE()) { ... */                  )
L(    swapgs                                                                  )
L(    pushq  $4f /* return_address */                                         )
L(    pushq  %rax                                                             )
...
#ifdef __x86_64__
L(    testb  $0x3, FRAME_SIZE+__ASM_SCRATCH_SIZE+IRREGS_I_OFFSETOF_CS(%rsp)   )
L(    jz     1f /* if (ORIGINATES_FROM_USERSPACE()) { ... */                  )
L(    swapgs                                                                  )
...
L(    PUSH_FRAME(__ASM_SCRATCH_SIZE+IRREGS_I_OFFSETOF_IP)                     )
#ifdef __x86_64__
L(    testb  $0x3, __ASM_SCRATCH_SIZE+IRREGS_IE_OFFSETOF_CS(%rsp)             )
L(    jz     1f /* if (ORIGINATES_FROM_USERSPACE()) { ... */                  )
L(    swapgs                                                                  )
L(    ADJUST_INTNO_TO_INTERRUPT(%FASTCALL_REG1)                               )
L(    call   exec_fastirq                                                     )
...
#ifdef __x86_64__
L(    testb  $0x3, FRAME_SIZE+__ASM_SCRATCH_SIZE+IRREGS_IE_OFFSETOF_CS(%rsp)  )
L(    jz     1f /* if (ORIGINATES_FROM_USERSPACE()) { ... */                  )
L(    swapgs                                                                  )
L(    ADJUST_INTNO_TO_INTERRUPT(%FASTCALL_REG1)                               )
L(    call   exec_basiirq                                                     )
