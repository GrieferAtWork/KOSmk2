 ...
 */
#ifndef GUARD_KERNEL_ARCH_USER64_C_INL
#define GUARD_KERNEL_ARCH_USER64_C_INL 1
...
L(3:  cmpx_sym(%r10,__kernel_user_start,%rsi)                    )
L(    jb    1b /* if (dst < __kernel_user_start) fail(); */      )
L(    cmpx_sym(%r10,__kernel_user_end,%rdx)                      )
...
L(1:  ret                                                        )
L(2:  cmpx_sym(%r10,__kernel_user_start,%rdi)                    )
L(    jb    1b /* if (str < __kernel_user_start) return NULL; */ )
L(    cmpx_sym(%r10,__kernel_user_end,%rdi)                      )
...
L(3:  cmpx_sym(%r10,__kernel_user_start,%rsi)                    )
L(    jb    1b /* if (str < __kernel_user_start) return NULL; */ )
L(    cmpx_sym(%r10,__kernel_user_end,%rsi)                      )
L(    jae   1b /* if (str >= __kernel_user_end) return NULL; */  )
L(    movq  %r10, %rax                                           )
L(    subq  %rsi, %rax                                           )
L(    jmp   4b                                                   )
...
L(    jae   98f                                                  )
#if defined(ASM_USE_MOVABS) || defined(ASM_USE_LEAIP)
L(    leaq  transmute(%rip), %r10                                )
L(    jmpq *(%r10,%rsi,8) /* Transmute registers. */             )
#else
L(    jmpq *transmute(,%rsi,8) /* Transmute registers. */        )
#endif
L(                                                               )
...
#endif /* !GUARD_KERNEL_ARCH_USER64_C_INL */
