...
INTDEF ssize_t LIBCCALL libc_freadlink(int fd, char *__restrict buf, size_t len);
...
INTDEF int LIBCCALL libc_dos_frenameat(int oldfd, char const *old, int newfd, char const *new_, int flags);
INTDEF ssize_t LIBCCALL libc_dos_readlinkat(int fd, char const *__restrict path, char *__restrict buf, size_t len);
...
INTDEF ssize_t LIBCCALL libc_dos_readlink(char const *__restrict path, char *__restrict buf, size_t len);
...
INTDEF int LIBCCALL libc_16wremove(char16_t const *file);
INTDEF int LIBCCALL libc_32wremove(char32_t const *file);
...
INTDEF int LIBCCALL libc_dos_16wremove(char16_t const *file);
INTDEF int LIBCCALL libc_dos_32wremove(char32_t const *file);
...
INTDEF intptr_t LIBCCALL libc_16wspawnv(int mode, char16_t const *path, char16_t *const argv[]);
INTDEF intptr_t LIBCCALL libc_16wspawnve(int mode, char16_t const *path, char16_t *const argv[], char16_t *const envp[]);
INTDEF intptr_t LIBCCALL libc_16wspawnvp(int mode, char16_t const *file, char16_t *const argv[]);
INTDEF intptr_t LIBCCALL libc_16wspawnvpe(int mode, char16_t const *file, char16_t *const argv[], char16_t *const envp[]);
INTDEF intptr_t LIBCCALL libc_32wspawnv(int mode, char32_t const *path, char32_t *const argv[]);
INTDEF intptr_t LIBCCALL libc_32wspawnve(int mode, char32_t const *path, char32_t *const argv[], char32_t *const envp[]);
INTDEF intptr_t LIBCCALL libc_32wspawnvp(int mode, char32_t const *file, char32_t *const argv[]);
INTDEF intptr_t LIBCCALL libc_32wspawnvpe(int mode, char32_t const *file, char32_t *const argv[], char32_t *const envp[]);
INTDEF intptr_t LIBCCALL libc_dos_16wspawnv(int mode, char16_t const *path, char16_t *const argv[]);
INTDEF intptr_t LIBCCALL libc_dos_16wspawnve(int mode, char16_t const *path, char16_t *const argv[], char16_t *const envp[]);
INTDEF intptr_t LIBCCALL libc_dos_16wspawnvp(int mode, char16_t const *file, char16_t *const argv[]);
INTDEF intptr_t LIBCCALL libc_dos_16wspawnvpe(int mode, char16_t const *file, char16_t *const argv[], char16_t *const envp[]);
INTDEF intptr_t LIBCCALL libc_dos_32wspawnv(int mode, char32_t const *path, char32_t *const argv[]);
INTDEF intptr_t LIBCCALL libc_dos_32wspawnve(int mode, char32_t const *path, char32_t *const argv[], char32_t *const envp[]);
INTDEF intptr_t LIBCCALL libc_dos_32wspawnvp(int mode, char32_t const *file, char32_t *const argv[]);
INTDEF intptr_t LIBCCALL libc_dos_32wspawnvpe(int mode, char32_t const *file, char32_t *const argv[], char32_t *const envp[]);
INTDEF intptr_t ATTR_CDECL libc_16wspawnl(int mode, char16_t const *path, char16_t const *arg, ...);
INTDEF intptr_t ATTR_CDECL libc_16wspawnle(int mode, char16_t const *path, char16_t const *arg, ...);
INTDEF intptr_t ATTR_CDECL libc_16wspawnlp(int mode, char16_t const *file, char16_t const *arg, ...);
INTDEF intptr_t ATTR_CDECL libc_16wspawnlpe(int mode, char16_t const *file, char16_t const *arg, ...);
INTDEF intptr_t ATTR_CDECL libc_32wspawnl(int mode, char32_t const *path, char32_t const *arg, ...);
INTDEF intptr_t ATTR_CDECL libc_32wspawnle(int mode, char32_t const *path, char32_t const *arg, ...);
INTDEF intptr_t ATTR_CDECL libc_32wspawnlp(int mode, char32_t const *file, char32_t const *arg, ...);
INTDEF intptr_t ATTR_CDECL libc_32wspawnlpe(int mode, char32_t const *file, char32_t const *arg, ...);
INTDEF intptr_t ATTR_CDECL libc_dos_16wspawnl(int mode, char16_t const *path, char16_t const *arg, ...);
INTDEF intptr_t ATTR_CDECL libc_dos_16wspawnle(int mode, char16_t const *path, char16_t const *arg, ...);
INTDEF intptr_t ATTR_CDECL libc_dos_16wspawnlp(int mode, char16_t const *file, char16_t const *arg, ...);
INTDEF intptr_t ATTR_CDECL libc_dos_16wspawnlpe(int mode, char16_t const *file, char16_t const *arg, ...);
INTDEF intptr_t ATTR_CDECL libc_dos_32wspawnl(int mode, char32_t const *path, char32_t const *arg, ...);
INTDEF intptr_t ATTR_CDECL libc_dos_32wspawnle(int mode, char32_t const *path, char32_t const *arg, ...);
INTDEF intptr_t ATTR_CDECL libc_dos_32wspawnlp(int mode, char32_t const *file, char32_t const *arg, ...);
INTDEF intptr_t ATTR_CDECL libc_dos_32wspawnlpe(int mode, char32_t const *file, char32_t const *arg, ...);
