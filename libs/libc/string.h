...
__LIBC ssize_t (__LIBCCALL libc_16wprintf)(wchar_t const *__restrict __format, ...);
__LIBC ssize_t (__LIBCCALL libc_16swprintf)(wchar_t *__restrict __s, size_t __n, wchar_t const *__restrict __format, ...);
__LIBC ssize_t (__LIBCCALL libc_16vfwprintf)(__FILE *__restrict __s, wchar_t const *__restrict __format, __VA_LIST __arg);
__LIBC ssize_t (__LIBCCALL libc_16vwprintf)(wchar_t const *__restrict __format, __VA_LIST __arg);
__LIBC ssize_t (__LIBCCALL libc_16vswprintf)(wchar_t *__restrict __s, size_t __n, wchar_t const *__restrict __format, __VA_LIST __arg);
__LIBC ssize_t (__LIBCCALL libc_16fwscanf)(__FILE *__restrict __stream, wchar_t const *__restrict __format, ...);
__LIBC ssize_t (__LIBCCALL libc_16wscanf)(wchar_t const *__restrict __format, ...);
__LIBC ssize_t (__LIBCCALL libc_16swscanf)(wchar_t const *__restrict __s, wchar_t const *__restrict __format, ...);
__LIBC ssize_t (__LIBCCALL libc_16vfwscanf)(__FILE *__restrict __s, wchar_t const *__restrict __format, __VA_LIST __arg);
__LIBC ssize_t (__LIBCCALL libc_16vwscanf)(wchar_t const *__restrict __format, __VA_LIST __arg);
__LIBC ssize_t (__LIBCCALL libc_16vswscanf)(wchar_t const *__restrict __s, wchar_t const *__restrict __format, __VA_LIST __arg);
__LIBC __FILE *(__LIBCCALL libc_16open_wmemstream)(wchar_t **__bufloc, size_t *__sizeloc);
...
#if 0 /* TODO */
__LIBC errno_t LIBCCALL _cgetws_s(wchar_t *__buffer, size_t buflen, size_t *__sizeok) __ASMNAME("_getws_s");
__LIBC wchar_t *LIBCCALL _cgetws(wchar_t *__buffer) __ASMNAME("_getws");
...
__LIBC wint_t LIBCCALL _putwch(wchar_t wc) __ASMNAME("putwchar");
__LIBC wint_t LIBCCALL _putwch_nolock(wchar_t wc) __ASMNAME("putwchar_unlocked");
__LIBC wint_t LIBCCALL _ungetwch(wint_t wc);
__LIBC wint_t LIBCCALL _ungetwch_nolock(wint_t wc);
__LIBC int LIBCCALL _cputws(wchar_t const *__string) __ASMNAME("_putws");
__LIBC int ATTR_CDECL _cwprintf(wchar_t const *__format, ...) __ASMNAME("wprintf");
__LIBC int ATTR_CDECL _cwprintf_p(wchar_t const *__format, ...) __ASMNAME("wprintf");
__LIBC int ATTR_CDECL _cwprintf_s(wchar_t const *__format, ...) __ASMNAME("wprintf");
__LIBC int LIBCCALL _vcwprintf(wchar_t const *__format, __VA_LIST __args) __ASMNAME("vwprintf");
__LIBC int LIBCCALL _vcwprintf_p(wchar_t const*__format, __VA_LIST __args) __ASMNAME("vwprintf");
__LIBC int LIBCCALL _vcwprintf_s(wchar_t const *__format, __VA_LIST __args) __ASMNAME("vwprintf");
__LIBC int ATTR_CDECL _cwprintf_l(wchar_t const *__format, locale_t locale, ...) __ASMNAME("_wprintf_l");
__LIBC int ATTR_CDECL _cwprintf_p_l(wchar_t const *__format, locale_t locale, ...) __ASMNAME("_wprintf_l");
__LIBC int ATTR_CDECL _cwprintf_s_l(wchar_t const *__format, locale_t locale, ...) __ASMNAME("_wprintf_l");
__LIBC int LIBCCALL _vcwprintf_l(wchar_t const *__format, locale_t locale, __VA_LIST __args) __ASMNAME("_vwprintf_l");
__LIBC int LIBCCALL _vcwprintf_p_l(wchar_t const *__format, locale_t locale, __VA_LIST __args) __ASMNAME("_vwprintf_l");
__LIBC int LIBCCALL _vcwprintf_s_l(wchar_t const *__format, locale_t locale, __VA_LIST __args) __ASMNAME("_vwprintf_l");
__LIBC int ATTR_CDECL _cwscanf(wchar_t const *__format, ...) __ASMNAME("wscanf");
__LIBC int ATTR_CDECL _cwscanf_s(wchar_t const *__format, ...) __ASMNAME("wscanf");
__LIBC int ATTR_CDECL _cwscanf_l(wchar_t const *__format, locale_t locale, ...) __ASMNAME("_wscanf_l");
__LIBC int ATTR_CDECL _cwscanf_s_l(wchar_t const *__format, locale_t locale, ...) __ASMNAME("_wscanf_l");
__LIBC FILE *LIBCCALL _wfdopen(int __fd, wchar_t const *__restrict __mode);
__LIBC FILE *LIBCCALL _wfopen(wchar_t const *__file, wchar_t const *__mode);
__LIBC FILE *LIBCCALL _wfreopen(wchar_t const *__file, wchar_t const *__mode, FILE *__fp);
__LIBC FILE *LIBCCALL _wfsopen(wchar_t const *__file, wchar_t const *__mode, int __sflag);
__LIBC FILE *LIBCCALL _wpopen(wchar_t const *__cmd, wchar_t const *__mode);
__LIBC errno_t LIBCCALL _wfopen_s(FILE **__restrict __pfp, wchar_t const *__file, wchar_t const *__mode);
__LIBC errno_t LIBCCALL _wfreopen_s(FILE **__restrict __pfp, wchar_t const *__file, wchar_t const *__mode, FILE *__restrict __fp);
__LIBC wint_t LIBCCALL getwchar(void);
__LIBC wint_t LIBCCALL putwchar(wchar_t wc);
__LIBC wint_t LIBCCALL _fgetwchar(void) __ASMNAME("getwchar");
__LIBC wint_t LIBCCALL _fputwchar(wchar_t wc) __ASMNAME("putwchar");
__LIBC wint_t LIBCCALL fgetwc(FILE *__restrict __fp);
__LIBC wint_t LIBCCALL fputwc(wchar_t wc, FILE *__restrict __fp);
__LIBC wint_t LIBCCALL getwc(FILE *__restrict __fp) __ASMNAME("fgetwc");
__LIBC wint_t LIBCCALL putwc(wchar_t wc, FILE *__restrict __fp) __ASMNAME("fputwc");
__LIBC wint_t LIBCCALL ungetwc(wint_t wc, FILE *__restrict __fp);
__LIBC wchar_t *LIBCCALL _getws_s(wchar_t *__restrict __s, size_t __dstlen);
__LIBC wchar_t *LIBCCALL fgetws(wchar_t *__restrict buf, int __dstlen, FILE *__restrict __fp);
__LIBC int LIBCCALL _putws(wchar_t const *__restrict __s);
__LIBC int LIBCCALL fputws(wchar_t const *__restrict __s, FILE *__restrict __fp);
__LIBC errno_t LIBCCALL _wtmpnam_s(wchar_t *__restrict buf, size_t buflen);
__LIBC wchar_t *LIBCCALL _wtempnam(wchar_t const *__restrict __dir, wchar_t const *__restrict __prefix);
__LIBC wchar_t *LIBCCALL _wtmpnam(wchar_t *__restrict buf);
__LIBC wint_t LIBCCALL _fgetwc_nolock(FILE *__restrict __fp) __ASMNAME("fgetwc_unlocked");
__LIBC wint_t LIBCCALL _fputwc_nolock(wchar_t wc, FILE *__restrict __fp) __ASMNAME("fputwc_unlocked");
__LIBC wint_t LIBCCALL _ungetwc_nolock(wint_t wc, FILE *__restrict __fp);
__LIBC int ATTR_CDECL _fwprintf_l(FILE *__restrict __fp, wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _fwprintf_p(FILE *__restrict __fp, wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL _fwprintf_p_l(FILE *__restrict __fp, wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _fwprintf_s_l(FILE *__restrict __fp, wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _fwscanf_l(FILE *__restrict __fp, wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _fwscanf_s_l(FILE *__restrict __fp, wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _scwprintf(wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL _scwprintf_l(wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _scwprintf_p(wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL _scwprintf_p_l(wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _snwprintf(wchar_t *__restrict buf, size_t buflen, wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL _snwprintf_l(wchar_t *__restrict buf, size_t maxlen, wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _snwprintf_s(wchar_t *__restrict buf, size_t buflen, size_t maxlen, wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL _snwprintf_s_l(wchar_t *__restrict buf, size_t dstsize, size_t maxlen, wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _snwscanf(wchar_t const *__restrict src, size_t maxlen, wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL _snwscanf_l(wchar_t const *__restrict src, size_t maxlen, wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _snwscanf_s(wchar_t const *__restrict src, size_t maxlen, wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL _snwscanf_s_l(wchar_t const *__restrict src, size_t maxlen, wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _swprintf_c(wchar_t *__restrict buf, size_t buflen, wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL _swprintf_c_l(wchar_t *__restrict buf, size_t maxlen, wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _swprintf_p(wchar_t *__restrict buf, size_t maxlen, wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL _swprintf_p_l(wchar_t *__restrict buf, size_t maxlen, wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _swprintf_s_l(wchar_t *__restrict buf, size_t dstsize, wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _swscanf_l(wchar_t const *__restrict src, wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _swscanf_s_l(wchar_t const *__restrict src, wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _wprintf_l(wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _wprintf_p(wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL _wprintf_p_l(wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _wprintf_s_l(wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _wscanf_l(wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL _wscanf_s_l(wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int ATTR_CDECL fwprintf(FILE *__restrict __fp, wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL fwscanf(FILE *__restrict __fp, wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL swprintf(wchar_t *__restrict buf, size_t __count, wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL swscanf(wchar_t const *__restrict src, wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL wprintf(wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL wscanf(wchar_t const *__restrict __format, ...);
__LIBC int LIBCCALL _swprintf_l(wchar_t *__restrict buf, size_t __count, wchar_t const *__restrict __format, locale_t locale, ...);
__LIBC int LIBCCALL _vfwprintf_l(FILE *__restrict __fp, wchar_t const *__restrict __format, locale_t locale, __VA_LIST __args);
__LIBC int LIBCCALL _vfwprintf_p(FILE *__restrict __fp, wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC int LIBCCALL _vfwprintf_p_l(FILE *__restrict __fp, wchar_t const *__restrict __format, locale_t locale, __VA_LIST __args);
__LIBC int LIBCCALL _vfwprintf_s_l(FILE *__restrict __fp, wchar_t const *__restrict __format, locale_t locale, __VA_LIST __args);
__LIBC int LIBCCALL _vscwprintf(wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC int LIBCCALL _vscwprintf_l(wchar_t const *__restrict __format, locale_t locale, __VA_LIST __args);
__LIBC int LIBCCALL _vscwprintf_p(wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC int LIBCCALL _vscwprintf_p_l(wchar_t const *__restrict __format, locale_t locale, __VA_LIST __args);
__LIBC int LIBCCALL _vsnwprintf(wchar_t *__restrict buf, size_t buflen, wchar_t const *__restrict __format, __VA_LIST _Args);
__LIBC int LIBCCALL _vsnwprintf_l(wchar_t *__restrict buf, size_t maxlen, wchar_t const *__restrict __format, locale_t locale, __VA_LIST __args);
__LIBC int LIBCCALL _vsnwprintf_s(wchar_t *__restrict buf, size_t buflen, size_t maxlen, wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC int LIBCCALL _vsnwprintf_s_l(wchar_t *__restrict buf, size_t dstsize, size_t maxlen, wchar_t const *__restrict __format, locale_t locale, __VA_LIST __args);
__LIBC int LIBCCALL _vswprintf_c(wchar_t *__restrict buf, size_t buflen, wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC int LIBCCALL _vswprintf_c_l(wchar_t *__restrict buf, size_t maxlen, wchar_t const *__restrict __format, locale_t locale, __VA_LIST __args);
__LIBC int LIBCCALL _vswprintf_l(wchar_t *__restrict buf, size_t __count, wchar_t const *__restrict __format, locale_t locale, __VA_LIST __args);
__LIBC int LIBCCALL _vswprintf_p(wchar_t *__restrict buf, size_t maxlen, wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC int LIBCCALL _vswprintf_p_l(wchar_t *__restrict buf, size_t maxlen, wchar_t const *__restrict __format, locale_t locale, __VA_LIST __args);
__LIBC int LIBCCALL _vswprintf_s_l(wchar_t *__restrict buf, size_t dstsize, wchar_t const *__restrict __format, locale_t locale, __VA_LIST __args);
__LIBC int LIBCCALL _vwprintf_l(wchar_t const *__restrict __format, locale_t locale, __VA_LIST __args);
__LIBC int LIBCCALL _vwprintf_p(wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC int LIBCCALL _vwprintf_p_l(wchar_t const *__restrict __format, locale_t locale, __VA_LIST __args);
__LIBC int LIBCCALL _vwprintf_s_l(wchar_t const *__restrict __format, locale_t locale, __VA_LIST __args);
__LIBC int LIBCCALL _wremove(wchar_t const *__restrict __file);
__LIBC int LIBCCALL vfwprintf(FILE *__restrict __fp, wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC int LIBCCALL vfwscanf(FILE *__restrict __fp, wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC int LIBCCALL vswprintf(wchar_t *__restrict buf, size_t __count, wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC int LIBCCALL vswscanf(wchar_t const *__restrict src, wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC int LIBCCALL vwprintf(wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC int LIBCCALL vwscanf(wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC int ATTR_CDECL wprintf_s(wchar_t const *__restrict __restrict __format, ...);
__LIBC int ATTR_CDECL swprintf_s(wchar_t *__restrict buf, size_t buflen, wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL fwprintf_s(FILE *__restrict __fp, wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL wscanf_s(wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL swscanf_s(wchar_t const *__restrict src, wchar_t const *__restrict __format, ...);
__LIBC int ATTR_CDECL fwscanf_s(FILE *__restrict __fp, wchar_t const *__restrict __format, ...);
__LIBC int LIBCCALL vwprintf_s(wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC int LIBCCALL vswprintf_s(wchar_t *__restrict buf, size_t buflen, wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC int LIBCCALL vfwprintf_s(FILE *__restrict __fp, wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC int LIBCCALL vwscanf_s(wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC int LIBCCALL vswscanf_s(wchar_t const *__restrict dst, wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC int LIBCCALL vfwscanf_s(FILE *__restrict __fp, wchar_t const *__restrict __format, __VA_LIST __args);
__LIBC wchar_t *LIBCCALL _itow(int val, wchar_t *__restrict dst, int __radix);
__LIBC wchar_t *LIBCCALL _ultow(unsigned long val,  wchar_t *__restrict dst, int __radix);
__LIBC wchar_t *LIBCCALL _i64tow(__INT64_TYPE__ val, wchar_t *__restrict dst, int __radix);
__LIBC wchar_t *LIBCCALL _ui64tow(__UINT64_TYPE__ val, wchar_t *__restrict dst, int __radix);
__LIBC errno_t LIBCCALL _itow_s(int val, wchar_t *__restrict dst, size_t maxlen, int __radix);
__LIBC errno_t LIBCCALL _ultow_s(unsigned long val, wchar_t *dst, size_t maxlen, int __radix);
__LIBC errno_t LIBCCALL _i64tow_s(__INT64_TYPE__ val, wchar_t *__restrict dst, size_t maxlen, int __radix);
...
__LIBC errno_t LIBCCALL _wcserror_s(wchar_t *__restrict buf, size_t maxlen, int __errnum);
__LIBC errno_t LIBCCALL __wcserror_s(wchar_t *__restrict buf, size_t maxlen, wchar_t const *__restrict __errmsg);
...
__LIBC wchar_t *LIBCCALL _wctime32(__time32_t const *__restrict __timer);
__LIBC wchar_t *LIBCCALL _wctime64(__time64_t const *__restrict __timer);
__LIBC errno_t LIBCCALL _wctime32_s(wchar_t buf[26], size_t maxlen, __time32_t const *__restrict __timer);
__LIBC errno_t LIBCCALL _wctime64_s(wchar_t buf[26], size_t maxlen, __time64_t const *__restrict __timer);
#endif
