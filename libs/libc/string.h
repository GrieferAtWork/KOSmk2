...
#if !defined(CONFIG_NO_64BIT_STRING) && __SIZEOF_POINTER__ >= 8
#define CONFIG_NATIVE_64BIT_STRING 1
#endif
...
INTDEF int LIBCCALL libc_memcmpw(void const *a, void const *b, size_t n_words);
...
INTDEF int LIBCCALL libc_memcmpl(void const *a, void const *b, size_t n_dwords);
...
INTDEF int LIBCCALL libc_memcmpq(void const *a, void const *b, size_t n_qwords);
...
INTDEF void *LIBCCALL libc_mempatq(void *__restrict dst, u64 pattern, size_t n_bytes);
...
struct errnotext_data {
 u32 etd_version; /*< == STRERROR_VERSION (Strerror-data version; will always be backwards-compatible). */
 s32 etd_strtab;  /*< Offset from `strerror_data' to a string table. */
 s32 etd_enotab;  /*< Offset from `strerror_data' to a vector of `struct errnotext_entry'. */
 u32 etd_enocnt;  /*< Amount of entires in `etd_enotab'. */
 u32 etd_enoent;  /*< Size of a single entry within `etd_enotab'. */
};
...
INTDEF double LIBCCALL libc_atof_l(char const *__restrict nptr, locale_t locale);
...
INTDEF void LIBCCALL libc_makepath(char *__restrict buf, char const *drive, char const *dir, char const *file, char const *ext);
INTDEF void LIBCCALL libc_16wmakepath(char16_t *__restrict buf, char16_t const *drive, char16_t const *dir, char16_t const *file, char16_t const *ext);
INTDEF void LIBCCALL libc_32wmakepath(char32_t *__restrict buf, char32_t const *drive, char32_t const *dir, char32_t const *file, char32_t const *ext);
INTDEF errno_t LIBCCALL libc_makepath_s(char *__restrict buf, size_t buflen, char const *drive, char const *dir, char const *file, char const *ext);
INTDEF errno_t LIBCCALL libc_16wmakepath_s(char16_t *__restrict buf, size_t maxlen, char16_t const *drive, char16_t const *dir, char16_t const *file, char16_t const *ext);
INTDEF errno_t LIBCCALL libc_32wmakepath_s(char32_t *__restrict buf, size_t maxlen, char32_t const *drive, char32_t const *dir, char32_t const *file, char32_t const *ext);

INTDEF void LIBCCALL libc_splitpath(char const *__restrict abspath, char *drive, char *dir, char *file, char *ext);
INTDEF void LIBCCALL libc_16wsplitpath(char16_t const *__restrict abspath, char16_t *drive, char16_t *dir, char16_t *file, char16_t *ext);
INTDEF void LIBCCALL libc_32wsplitpath(char32_t const *__restrict abspath, char32_t *drive, char32_t *dir, char32_t *file, char32_t *ext);
...
INTDEF errno_t LIBCCALL _searchenv_s(char const *file, char const *envvar, char *resultpath, size_t buflen);
INTDEF errno_t LIBCCALL _wsearchenv_s(char16_t const *__restrict file, char16_t const *__restrict varname, char16_t *__restrict dst, size_t maxlen);
...
__LIBC ssize_t (__LIBCCALL libc_16fwprintf)(__FILE *__restrict __stream, char16_t const *__restrict format, ...);
__LIBC ssize_t (__LIBCCALL libc_16wprintf)(char16_t const *__restrict format, ...);
__LIBC ssize_t (__LIBCCALL libc_16swprintf)(char16_t *__restrict __s, size_t __n, char16_t const *__restrict format, ...);
__LIBC ssize_t (__LIBCCALL libc_16vfwprintf)(__FILE *__restrict __s, char16_t const *__restrict format, va_list __arg);
__LIBC ssize_t (__LIBCCALL libc_16vwprintf)(char16_t const *__restrict format, va_list __arg);
__LIBC ssize_t (__LIBCCALL libc_16vswprintf)(char16_t *__restrict __s, size_t __n, char16_t const *__restrict format, va_list __arg);
__LIBC ssize_t (__LIBCCALL libc_16fwscanf)(__FILE *__restrict __stream, char16_t const *__restrict format, ...);
__LIBC ssize_t (__LIBCCALL libc_16wscanf)(char16_t const *__restrict format, ...);
__LIBC ssize_t (__LIBCCALL libc_16swscanf)(char16_t const *__restrict __s, char16_t const *__restrict format, ...);
__LIBC ssize_t (__LIBCCALL libc_16vfwscanf)(__FILE *__restrict __s, char16_t const *__restrict format, va_list __arg);
__LIBC ssize_t (__LIBCCALL libc_16vwscanf)(char16_t const *__restrict format, va_list __arg);
__LIBC ssize_t (__LIBCCALL libc_16vswscanf)(char16_t const *__restrict __s, char16_t const *__restrict format, va_list __arg);
...
__LIBC int ATTR_CDECL _cwprintf(char16_t const *format, ...) __ASMNAME("wprintf");
__LIBC int ATTR_CDECL _cwprintf_p(char16_t const *format, ...) __ASMNAME("wprintf");
__LIBC int ATTR_CDECL _cwprintf_s(char16_t const *format, ...) __ASMNAME("wprintf");
__LIBC int LIBCCALL _vcwprintf(char16_t const *format, va_list args) __ASMNAME("vwprintf");
__LIBC int LIBCCALL _vcwprintf_p(char16_t const*format, va_list args) __ASMNAME("vwprintf");
__LIBC int LIBCCALL _vcwprintf_s(char16_t const *format, va_list args) __ASMNAME("vwprintf");
__LIBC int ATTR_CDECL _cwprintf_l(char16_t const *format, locale_t locale, ...) __ASMNAME("_wprintf_l");
__LIBC int ATTR_CDECL _cwprintf_p_l(char16_t const *format, locale_t locale, ...) __ASMNAME("_wprintf_l");
__LIBC int ATTR_CDECL _cwprintf_s_l(char16_t const *format, locale_t locale, ...) __ASMNAME("_wprintf_l");
__LIBC int LIBCCALL _vcwprintf_l(char16_t const *format, locale_t locale, va_list args) __ASMNAME("_vwprintf_l");
__LIBC int LIBCCALL _vcwprintf_p_l(char16_t const *format, locale_t locale, va_list args) __ASMNAME("_vwprintf_l");
__LIBC int LIBCCALL _vcwprintf_s_l(char16_t const *format, locale_t locale, va_list args) __ASMNAME("_vwprintf_l");
__LIBC int ATTR_CDECL _cwscanf(char16_t const *format, ...) __ASMNAME("wscanf");
__LIBC int ATTR_CDECL _cwscanf_s(char16_t const *format, ...) __ASMNAME("wscanf");
__LIBC int ATTR_CDECL _cwscanf_l(char16_t const *format, locale_t locale, ...) __ASMNAME("_wscanf_l");
__LIBC int ATTR_CDECL _cwscanf_s_l(char16_t const *format, locale_t locale, ...) __ASMNAME("_wscanf_l");
...
__LIBC FILE *LIBCCALL _wpopen(char16_t const *command, char16_t const *__mode);
...
__LIBC int ATTR_CDECL _fwprintf_l(FILE *__restrict __fp, char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _fwprintf_p(FILE *__restrict __fp, char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL _fwprintf_p_l(FILE *__restrict __fp, char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _fwprintf_s_l(FILE *__restrict __fp, char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _fwscanf_l(FILE *__restrict __fp, char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _fwscanf_s_l(FILE *__restrict __fp, char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _scwprintf(char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL _scwprintf_l(char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _scwprintf_p(char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL _scwprintf_p_l(char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _snwprintf(char16_t *__restrict buf, size_t buflen, char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL _snwprintf_l(char16_t *__restrict buf, size_t maxlen, char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _snwprintf_s(char16_t *__restrict buf, size_t buflen, size_t maxlen, char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL _snwprintf_s_l(char16_t *__restrict buf, size_t dstsize, size_t maxlen, char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _snwscanf(char16_t const *__restrict src, size_t maxlen, char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL _snwscanf_l(char16_t const *__restrict src, size_t maxlen, char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _snwscanf_s(char16_t const *__restrict src, size_t maxlen, char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL _snwscanf_s_l(char16_t const *__restrict src, size_t maxlen, char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _swprintf_c(char16_t *__restrict buf, size_t buflen, char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL _swprintf_c_l(char16_t *__restrict buf, size_t maxlen, char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _swprintf_p(char16_t *__restrict buf, size_t maxlen, char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL _swprintf_p_l(char16_t *__restrict buf, size_t maxlen, char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _swprintf_s_l(char16_t *__restrict buf, size_t dstsize, char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _swscanf_l(char16_t const *__restrict src, char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _swscanf_s_l(char16_t const *__restrict src, char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _wprintf_l(char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _wprintf_p(char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL _wprintf_p_l(char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _wprintf_s_l(char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _wscanf_l(char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL _wscanf_s_l(char16_t const *__restrict format, locale_t locale, ...);
__LIBC int ATTR_CDECL fwprintf(FILE *__restrict __fp, char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL fwscanf(FILE *__restrict __fp, char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL swprintf(char16_t *__restrict buf, size_t __count, char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL swscanf(char16_t const *__restrict src, char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL wprintf(char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL wscanf(char16_t const *__restrict format, ...);
__LIBC int LIBCCALL _swprintf_l(char16_t *__restrict buf, size_t __count, char16_t const *__restrict format, locale_t locale, ...);
__LIBC int LIBCCALL _vfwprintf_l(FILE *__restrict __fp, char16_t const *__restrict format, locale_t locale, va_list args);
__LIBC int LIBCCALL _vfwprintf_p(FILE *__restrict __fp, char16_t const *__restrict format, va_list args);
__LIBC int LIBCCALL _vfwprintf_p_l(FILE *__restrict __fp, char16_t const *__restrict format, locale_t locale, va_list args);
__LIBC int LIBCCALL _vfwprintf_s_l(FILE *__restrict __fp, char16_t const *__restrict format, locale_t locale, va_list args);
__LIBC int LIBCCALL _vscwprintf(char16_t const *__restrict format, va_list args);
__LIBC int LIBCCALL _vscwprintf_l(char16_t const *__restrict format, locale_t locale, va_list args);
__LIBC int LIBCCALL _vscwprintf_p(char16_t const *__restrict format, va_list args);
__LIBC int LIBCCALL _vscwprintf_p_l(char16_t const *__restrict format, locale_t locale, va_list args);
__LIBC int LIBCCALL _vsnwprintf(char16_t *__restrict buf, size_t buflen, char16_t const *__restrict format, va_list _Args);
__LIBC int LIBCCALL _vsnwprintf_l(char16_t *__restrict buf, size_t maxlen, char16_t const *__restrict format, locale_t locale, va_list args);
__LIBC int LIBCCALL _vsnwprintf_s(char16_t *__restrict buf, size_t buflen, size_t maxlen, char16_t const *__restrict format, va_list args);
__LIBC int LIBCCALL _vsnwprintf_s_l(char16_t *__restrict buf, size_t dstsize, size_t maxlen, char16_t const *__restrict format, locale_t locale, va_list args);
__LIBC int LIBCCALL _vswprintf_c(char16_t *__restrict buf, size_t buflen, char16_t const *__restrict format, va_list args);
__LIBC int LIBCCALL _vswprintf_c_l(char16_t *__restrict buf, size_t maxlen, char16_t const *__restrict format, locale_t locale, va_list args);
__LIBC int LIBCCALL _vswprintf_l(char16_t *__restrict buf, size_t __count, char16_t const *__restrict format, locale_t locale, va_list args);
__LIBC int LIBCCALL _vswprintf_p(char16_t *__restrict buf, size_t maxlen, char16_t const *__restrict format, va_list args);
__LIBC int LIBCCALL _vswprintf_p_l(char16_t *__restrict buf, size_t maxlen, char16_t const *__restrict format, locale_t locale, va_list args);
__LIBC int LIBCCALL _vswprintf_s_l(char16_t *__restrict buf, size_t dstsize, char16_t const *__restrict format, locale_t locale, va_list args);
__LIBC int LIBCCALL _vwprintf_l(char16_t const *__restrict format, locale_t locale, va_list args);
__LIBC int LIBCCALL _vwprintf_p(char16_t const *__restrict format, va_list args);
__LIBC int LIBCCALL _vwprintf_p_l(char16_t const *__restrict format, locale_t locale, va_list args);
__LIBC int LIBCCALL _vwprintf_s_l(char16_t const *__restrict format, locale_t locale, va_list args);
__LIBC int LIBCCALL _wremove(char16_t const *__restrict file);
__LIBC int LIBCCALL vfwprintf(FILE *__restrict __fp, char16_t const *__restrict format, va_list args);
__LIBC int LIBCCALL vfwscanf(FILE *__restrict __fp, char16_t const *__restrict format, va_list args);
__LIBC int LIBCCALL vswprintf(char16_t *__restrict buf, size_t __count, char16_t const *__restrict format, va_list args);
__LIBC int LIBCCALL vswscanf(char16_t const *__restrict src, char16_t const *__restrict format, va_list args);
__LIBC int LIBCCALL vwprintf(char16_t const *__restrict format, va_list args);
__LIBC int LIBCCALL vwscanf(char16_t const *__restrict format, va_list args);
__LIBC int ATTR_CDECL wprintf_s(char16_t const *__restrict __restrict format, ...);
__LIBC int ATTR_CDECL swprintf_s(char16_t *__restrict buf, size_t buflen, char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL fwprintf_s(FILE *__restrict __fp, char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL wscanf_s(char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL swscanf_s(char16_t const *__restrict src, char16_t const *__restrict format, ...);
__LIBC int ATTR_CDECL fwscanf_s(FILE *__restrict __fp, char16_t const *__restrict format, ...);
__LIBC int LIBCCALL vwprintf_s(char16_t const *__restrict format, va_list args);
__LIBC int LIBCCALL vswprintf_s(char16_t *__restrict buf, size_t buflen, char16_t const *__restrict format, va_list args);
__LIBC int LIBCCALL vfwprintf_s(FILE *__restrict __fp, char16_t const *__restrict format, va_list args);
__LIBC int LIBCCALL vwscanf_s(char16_t const *__restrict format, va_list args);
__LIBC int LIBCCALL vswscanf_s(char16_t const *__restrict dst, char16_t const *__restrict format, va_list args);
__LIBC int LIBCCALL vfwscanf_s(FILE *__restrict __fp, char16_t const *__restrict format, va_list args);
...
__LIBC char16_t *LIBCCALL _i64tow(s64 val, char16_t *__restrict dst, int __radix);
...
__LIBC errno_t LIBCCALL _i64tow_s(s64 val, char16_t *__restrict dst, size_t maxlen, int __radix);
...
__LIBC char16_t *LIBCCALL _wgetenv(char16_t const *__restrict varname);
__LIBC errno_t LIBCCALL _wgetenv_s(size_t *__restrict __psize, char16_t *__restrict buf, size_t buflen, char16_t const *__restrict varname);
__LIBC errno_t LIBCCALL _wdupenv_s(char16_t **__restrict __pbuf, size_t *__restrict __pbuflen, char16_t const *__restrict varname);
__LIBC int LIBCCALL _wsystem(char16_t const *__restrict command);
...
__LIBC char16_t *LIBCCALL _wfullpath(char16_t *abspath, char16_t const *__path, size_t maxlen);
