...
LOCAL SYSCALL4(__errno_t,faccessat,(int,dfd,USER char const *,filename,int,mode,int,flag));
LOCAL SYSCALL1(__errno_t,chdir,(USER char const *,path));
LOCAL SYSCALL1(__errno_t,chroot,(USER char const *,path));
LOCAL SYSCALL1(__errno_t,fchdir,(int,fd));
LOCAL SYSCALL2(__errno_t,fchmod,(int,fd,mode_t,mode));
LOCAL SYSCALL3(__errno_t,fchown,(int,fd,uid_t,user,gid_t,group));
LOCAL SYSCALL3(__errno_t,fchmodat,(int,dfd,USER char const *,filename,mode_t,mode));
LOCAL SYSCALL5(__errno_t,fchownat,(int,dfd,USER char const *,filename,uid_t,user,gid_t,group,int,flag));
...
LOCAL SYSCALL1(__errno_t,fdatasync,(int,fd));
LOCAL SYSCALL1(ssize_t,syncfs,(int,fs_fd));
LOCAL SYSCALL2(__errno_t,fstat64,(int,fd,USER struct stat64 *,statbuf));
LOCAL SYSCALL4(__errno_t,fstatat64,(int,dfd,USER char const *,filename,USER struct stat64 *,statbuf,int,flag));
LOCAL SYSCALL4(ssize_t,readlinkat,(int,fd,USER char const *,path,USER char *,buf,size_t,len));
LOCAL SYSCALL4(__errno_t,mknodat,(int,dfd,USER char const *,filename,mode_t,mode,dev_t,dev));
LOCAL SYSCALL3(__errno_t,mkdirat,(int,dfd,USER char const *,pathname,mode_t,mode));
LOCAL SYSCALL3(__errno_t,unlinkat,(int,dfd,USER char const *,pathname,int,flag));
LOCAL SYSCALL3(__errno_t,symlinkat,(USER char const *,oldname,int,newdfd,USER char const *,newname));
LOCAL SYSCALL5(__errno_t,linkat,(int,olddfd,USER char const *,oldname,int,newdfd,USER char const *,newname,int,flags));
LOCAL SYSCALL4(__errno_t,renameat,(int,olddfd,USER char const *,oldname,int,newdfd,USER char const *,newname));
LOCAL SYSCALL4(__errno_t,utimensat,(int,dfd,USER char const *,filename,USER struct kernel_timespec const *,utimes,int,flags));
...
LOCAL SYSCALL4(__errno_t,sigaction,(int,sig,USER struct sigaction const *,act,USER struct sigaction *,oact,size_t,sigsetsize));
...
LOCAL SYSCALL3(__errno_t,xfchdirat,(int,dfd,USER char const *,path,int,flags));
LOCAL SYSCALL5(__errno_t,xrenameat,(int,olddfd,USER char const *,oldname,int,newdfd,USER char const *,newname,int,flags));
...
LOCAL SYSCALL3(__errno_t,truncate,(USER char const *,path,syscall_ulong_t,len_hi,syscall_ulong_t,len_lo));
LOCAL SYSCALL3(__errno_t,ftruncate,(int,fd,syscall_ulong_t,len_hi,syscall_ulong_t,len_lo));
LOCAL SYSCALL6(__errno_t,fallocate,(int,fd,int,mode,syscall_ulong_t,off_hi,syscall_ulong_t,off_lo,syscall_ulong_t,len_hi,syscall_ulong_t,len_lo));
...
LOCAL SYSCALL2(__errno_t,truncate,(USER char const *,path,lpos_t,length));
LOCAL SYSCALL2(__errno_t,ftruncate,(int,fd,lpos_t,length));
LOCAL SYSCALL4(__errno_t,fallocate,(int,fd,int,mode,lpos_t,offset,lpos_t,length));
